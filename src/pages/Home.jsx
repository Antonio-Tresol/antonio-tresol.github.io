...
const EXPERIENCE = [
  ...
  },
  {
    ...
    title: (
      <>
        Lead AI/ML Engineer, <InlineLink href="https://www.crss.io/">Costa Rica Software Services</InlineLink>.
      </>
    ),
    note:
      (
    ...
    <>
      <Section style={{ paddingTop: "36px" }}>
        ...
        <P lead style={{ color: palette.text, marginTop: "6px", marginBottom: 0 }}>
          ...
          technical AI safety, interpretability and eliciting excellent
          autonomous work from AIs.
        </P>
